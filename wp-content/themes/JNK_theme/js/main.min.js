...
$(document).ready(function(){$("#navbarBtn").click(function(){$("#nav").toggleClass('show');});});let projectGridHeight=$('#projectGrid').height();$('#projectSection1').height(projectGridHeight/2);$('#projectSection2').height(projectGridHeight/2);$(function(){let projectGridHeight=$('#projectGrid').height();$('#projectSection1').height(projectGridHeight/2);$('#projectSection2').height(projectGridHeight/2);$(window).on("resize",function(){projectGridHeight=$('#projectGrid').height();$('#projectSection1').height(projectGridHeight/2);$('#projectSection2').height(projectGridHeight/2);});});hide=true;$('body').on('touchstart',function(){if(hide)$('#h1Icon').removeClass('active');hide=true;});$('body').on('touchstart','#h1Icon',function(){var self=$(this);if(self.hasClass('active')){$('#h1Icon').removeClass('active');return false;}
